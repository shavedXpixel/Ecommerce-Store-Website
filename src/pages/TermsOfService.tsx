...
const TermsOfService = () => {
  useEffect(() => {
    document.title = "Terms of Service - Priyansu Store";
  }, []);
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using the Priyansu Store website and services, you accept and agree to be bound by the terms and provision of this agreement. These Terms of Service govern your use of our website, products, and services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Permission is granted to temporarily download one copy of the materials on Priyansu Store's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Payment is due at the time of purchase. We accept UPI, major credit and debit cards, net banking, and wallets as displayed during checkout. All prices are in INR (₹) unless otherwise specified.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our products come with the original manufacturer warranty against defects, plus our additional support window on eligible categories. The warranty does not cover damage from accidental impact, liquid exposure, unauthorised repairs, or normal wear of consumables. Care and warranty details are included with each order and on each product page.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content on this website, including but not limited to text, graphics, logos, images, and software, is the property of Priyansu Store and is protected by copyright, trademark, and other intellectual property laws. Unauthorized use is prohibited.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall Priyansu Store or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on our website or products, even if we have been notified of the possibility of such damage.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 text-muted-foreground">
                <p>Email: legal@priyansustore.com</p>
                <p>Phone: +91 80 4567 0123</p>
                <p>Address: 27 Indiranagar 100ft Road, Bengaluru, KA 560038, India</p>
              </div>
            </section>
          </div>
        </div>
