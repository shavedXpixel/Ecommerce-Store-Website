...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { 
      ...
      images: [
        { src: "/founders.png", alt: "Priyansu Store gaming gear", label: "Read our story" }
      ]
    }
  ];
                      ...
                      <li key={index}>
                        <Link 
                          to={activeDropdown === "About"
                            ? `/about/${(subItem === "Buying Guide" ? "size-guide" : subItem).toLowerCase().replace(/\s+/g, '-')}`
                ...
                {navItems
                  ...
                  ?.images.map((image, index) => {
                    ...
                    if (activeDropdown === "Shop") {
                      if (image.label === "Laptops") linkTo = "/category/laptops";
                      else if (image.label === "Keyboards") linkTo = "/category/keyboards";
                    } else if (activeDropdown === "New in") {
                      if (image.label === "Phantom Air Mouse") linkTo = "/product/phantom-air-wireless-mouse";
                      else if (image.label === "Echo 7 Headset") linkTo = "/product/echo-7-wireless-headset";
