...
const FilterSortBar = ({ filtersOpen, setFiltersOpen, itemCount }: FilterSortBarProps) => {
  ...
  const categories = ["Laptops", "Keyboards", "Mice", "Monitors", "Headphones", "Accessories"];
  const priceRanges = ["Under ₹5,000", "₹5,000 - ₹20,000", "₹20,000 - ₹75,000", "Over ₹75,000"];
  const materials = ["ASUS", "Logitech", "Razer", "SteelSeries", "Corsair", "HyperX"];
            ...
            <Sheet open={filtersOpen} onOpenChange={setFiltersOpen}>
              ...
              <SheetContent side="right" className="w-80 bg-background border-none shadow-none">
                ...
                <div className="space-y-8">
                  ...
                  {/* Material Filter */}
                  <div>
                    <h3 className="text-sm font-light mb-4 text-foreground">Brand</h3>
                    <div className="space-y-3">
